...
DATA_UPLOAD_MAX_MEMORY_SIZE = int(get_env('DATA_UPLOAD_MAX_MEMORY_SIZE', 250 * 1024 * 1024 * 4))
DATA_UPLOAD_MAX_NUMBER_FILES = int(get_env('DATA_UPLOAD_MAX_NUMBER_FILES', 500))
...
# TODO: remove localhost:8010 after dev
_trusted = ['http://localhost:8010']
if CSRF_TRUSTED_ORIGINS:
    _trusted.extend(CSRF_TRUSTED_ORIGINS.split(','))
